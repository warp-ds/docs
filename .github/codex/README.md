...
2. OpenAI Codex uses `gpt-5.6-sol` with `xhigh` reasoning effort in a read-only sandbox to review the diff against the WARP Elements, React, Vue, iOS, and Android source repositories.
