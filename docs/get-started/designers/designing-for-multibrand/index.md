...
::: image-block
![Content transistioning from small screen to large screen](/get-started/be-an-effective-designer.svg)
:::
...
::: image-block
![FINN button with the text "Confirm"](/get-started/default-component-styling.svg)
:::
...
::: image-block
![FINN confirm button with a pointing arrow to a Tori confirm button](/get-started/variables-in-figma.svg)
:::
...
::: image-block
![Figma interface higtligting the selected frame is set to "Tori Light"](/get-started/variables-in-figma2.svg)
:::
