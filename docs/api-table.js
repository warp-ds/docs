export const react = {
  ...
  Link: {
    ...
    props: [
      ['className', 'string', '', 'Additional classes to include'],
      ['style', 'CSSProperties', '', 'CSS styles to inline on the component'],
      ['onClick', '(event: MouseEvent<HTMLAnchorElement>) => void', '', 'Handler that is called when the link is clicked.'],
      ...
      [
        ...
        "'small' | 'default'",
        'default',
        'Set the link to be either small or default size.',
      ],
      [
        'fullWidth',
        'boolean',
  	...
  	Toast: {
		...
		props: [
			...
			[
				...
				"boolean",
				"false",
				"Adds a close button. Not recommended from an accessibility perspective.",
			],
		],
	},
  Toggle: {
