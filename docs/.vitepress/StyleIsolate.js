if (typeof window !== 'undefined' && !customElements.get('style-isolate')) {
...
if (typeof window !== 'undefined' && !customElements.get('style-isolated')) {
  customElements.define(
    'style-isolated',
    class StyleIsolatedTypoNotice extends HTMLElement {
      connectedCallback() {
