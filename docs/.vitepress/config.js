          ...
          items: [
            {
              ...
              collapsed: true,
              items: [
                { text: 'Overview', link: '/patterns/empty-states/overview' },
                { text: 'Usage', link: '/patterns/empty-states/usage' },
                { text: 'Frameworks', link: '/patterns/empty-states/frameworks/android' },
                { text: 'Accessibility', link: '/patterns/empty-states/accessibility' },
              ],
            },
          ],
        },
