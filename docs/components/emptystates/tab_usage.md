...
**Don't use for**
- Global system messaging (e.g., system maintenance coming up). Use the [Alert](../alert/index.md) instead.
- Feedback messaging (e.g., address saved to favourites). Use the [Toast](../toast/index.md) instead.
