...
Do not use button variant link, it will be removed in later iterations.
* If you need a link that looks like a button, use `<w-link>`.
* If you need a link that looks like a link, use `<a>`.
