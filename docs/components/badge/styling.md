...
:::image-block
![Badge component with an icon on the left and text label, demonstrating spacing: 8px padding above and 4px padding on the left, right, and bottom.](/components/badge/badge-style-measurements.svg)
:::
