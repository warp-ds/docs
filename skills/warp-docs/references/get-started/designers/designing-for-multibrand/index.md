...
**Full documentation:** https://warp-ds.github.io/docs/get-started/designers/designing-for-multibrand
...
![Content transistioning from small screen to large screen](https://warp-ds.github.io/docs/get-started/be-an-effective-designer.png)
...
![WARP alert components displayed in the FINN brand and Tori brand](https://warp-ds.github.io/docs/get-started/multibrand-alerts.png)
...
![FINN button with the text "Confirm"](https://warp-ds.github.io/docs/get-started/default-component-styling.png)
...
![FINN confirm button with a pointing arrow to a Tori confirm button](https://warp-ds.github.io/docs/get-started/variables-in-figma.png)

Select a WARP component and select change variable mode in Layer settings in the right sidebar.

![Figma interface of a selected button pointing to the switch brand functionality](https://warp-ds.github.io/docs/get-started/figma-button-modes.svg)

You can also switch modes on entire frames and everything using variables will change.  
...
![Figma interface higtligting the selected frame is set to "Tori Light"](https://warp-ds.github.io/docs/get-started/variables-in-figma2.png)
