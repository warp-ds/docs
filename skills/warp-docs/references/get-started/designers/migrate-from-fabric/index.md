...
**Full documentation:** https://warp-ds.github.io/docs/get-started/designers/migrate-from-fabric
...
![Fabric logo pointed to the WARP logo](https://warp-ds.github.io/docs/get-started/migration.png)

**FINN first** The default styling for all components in WARP is FINN, you can switch to other brands whenever you want thanks to Figma variables and tokens.
