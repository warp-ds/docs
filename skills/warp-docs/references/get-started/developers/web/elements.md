...
**Full documentation:** https://warp-ds.github.io/docs/get-started/developers/web/elements

Warp custom elements are supplied by the Eik CDN. In addition, you can install the @warp-ds/elements package to get intellisense in your editor. Add the following script and style to the very top of your document head to ensure performant loading:
...
We ship `web-types.json` which should get picked up automatically by JetBrains IDEA and similar products. You should see code completions and inline docs for Warp elements when writing HTML.
