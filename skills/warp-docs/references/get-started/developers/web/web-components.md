...
**Full documentation:** https://warp-ds.github.io/docs/get-started/developers/web/web-components
...
![VS Code screenshot displaying use of intellisense for css tokens](https://warp-ds.github.io/docs/get-started/warp-css-intellisense.webp)
