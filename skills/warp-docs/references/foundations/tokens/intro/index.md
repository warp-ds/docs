...
**Full documentation:** https://warp-ds.github.io/docs/foundations/tokens/intro
...
![Displays how the hexvalue "#0063FB" points to the primitive color "Blue-600", used in the semantic token "color-background-primary", ultimately pointing to the pill component](https://warp-ds.github.io/docs/foundations/design-token-structure.png)
